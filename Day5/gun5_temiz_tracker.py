"""Bu modül, nesne takip (tracking) işlemlerini yöneten sınıfları içerir."""
import math
...
class Tracker:
    """Kişileri ve konumlarını takip eden ana sınıf."""
    ...
    def kisi_getir(self, kisi_id):
        """Verilen ID'ye sahip kişiyi döndürür."""
    ...
    def aktif_kisiler(self):
        """Sistemdeki mevcut kişilerin listesini verir."""
        return self.kisiler

    def _kisi_ekle(self, konum):
        """Yeni bir kişiyi sisteme kaydeder."""
        kisi = Kisi(self.siradaki_id, konum)
        self.kisiler[self.siradaki_id] = kisi
        self.siradaki_id += 1

    def guncelle(self, yeni_konumlar):
        """Yeni konumlara göre kişilerin yerini günceller ve eşleştirir."""
